...
@WebAppConfiguration
@ContextConfiguration(classes= {JPAConfiguration.class, ProdutoDAO.class, DataSourceConfigurationTest.class,AppWebConfiguration.class, SecurityConfiguration.class})
@ActiveProfiles("test")
public class ProdutosControllerTest {
	...
	@Before
	public void setup() {
		this.mocMvc = MockMvcBuilders.webAppContextSetup(wac).addFilter(springSecurityFilterChain).build();
	}
	...
	public void somenteAdminDeveAcessarProdutosForm() throws Exception {
		mocMvc.perform(MockMvcRequestBuilders.get("/produtos/form")
				.with(SecurityMockMvcRequestPostProcessors.user("user@casadocodigo.com.br").password("123456").roles("USUARIO")))
